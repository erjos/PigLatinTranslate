		...
		do {
			...
			do {
				...
				if (letter1 == 'a' || letter1 == 'e' || letter1 == 'i' || letter1 == 'o' || letter1 == 'u') {
					...
					//if the input doesn't have any vowels (ie.numbers) , an exception is thrown here
					...
					for (iVowel = 0; iVowel <= word.length(); iVowel++) {
						if (word.charAt(iVowel) == 'a' || word.charAt(iVowel) == 'e' || word.charAt(iVowel) == 'i'
							...
							System.out.println("This aint no real word bruh! Try again...");
							break;
						}
			...
			// in the greater "do while" loop, I need to consider that the
			// starting point should be reset to zero
